...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is NewsCommentModule
                   DESC

  s.homepage     = "https://github.com/ModuleLovePlay/NewsCommentModule"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/NewsCommentModule.git", :tag => s.version.to_s }
